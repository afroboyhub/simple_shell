...
/**
 * get_builtin - matches a command with corresponding shell
 ...
 * @front: a double pointer to beginning args
 *
 * Return: if no args -3, if invalid 2 or exits with given status
 */
...
/**
 * shellby_help - displays info about shellby builtin command
 * @args: an array of arguments
