...
/**
 * get_env_value - gets teh value corresponding to env
 * @beginning: the env var to search
 * @len: teh length of the env var
 *
 * Return: if the var not found empty string or value of the env
 */
 ...
 * @exe_ret: a pointer to the return value of exe command
 */
